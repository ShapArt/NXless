...
ams::Result ControlService::GetStatus(ams::sf::Out<nxless::ipc::RuntimeStatus> out) noexcept {
    const auto state = state_.Load();
    *out=runtime_.GetStatus(state.mode,disable_flag_,state.last_internal_error);
    R_SUCCEED();
}
